...
<head>
    ...
    <link rel="stylesheet" href="../librarian/css/home.css">
    <link rel="stylesheet" href="../librarian/css/navbar.css">
...
<body>
    ...
    <section id="aboutus">
        ...
        <div class="aboutus-box">
            ...
            <div class="aboutus-image">
                <img src="../librarian/images/books1.avif">
            </div>
        </div>
    </section>
    ...
    <section id="contactus">
        <img src="../librarian/images/footer2.png" class="contact-img">
        <div class="title-text">
            <p>CONTACT</p>
