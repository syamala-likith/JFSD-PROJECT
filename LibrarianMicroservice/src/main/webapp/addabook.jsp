...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../librarian/css/addabook.css" />
    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          ...
          <form method="post" action="addbook" class="sign-in-form">
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          ...
          <img src="../librarian/images/addabook.svg" class="image" alt="" />
        </div>
      </div>
    </div>
