...
<html lang="en">
  <head>
    ...
    <title>Add a User with Book</title>
    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          ...
          <form method="post" action="adduserwithbook" class="sign-in-form">
            <h2 class="title">Add a User</h2>
            
            
            <input type="text" name="bid" placeholder="Book ID" value="${book.id}" required="required" hidden/>
            <input type="text" name="bname" placeholder="Book Name" value="${book.name}" required="required" hidden/>
            
            
    		<div class="input-field">
              <i class="fas fa-user"></i>
              <div style="margin-top: 13px; width:100%;">
			  <select name="uid" class="js-example-basic-single" required="required">
            ...
            <div class="input-field">
              ...
              <input type="date" name="takendate" placeholder="Taken On" required="required"/>
            </div>
            
            <div class="input-field">
              <i class="fas fa-solid fa-message"></i>
              <input type="number" name="noofcopies" min="1" placeholder="Total Copies"/>
            </div>
