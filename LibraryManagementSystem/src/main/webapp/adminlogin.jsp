    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          ...
          <form method="post" action="checkadminlogin" class="sign-in-form">
          ...
          <form method="post" action="insertadmin" class="sign-up-form">
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <div class="content">
            ...
            <br>
            <p>
              Please Sign In to proceed to Admin Dashboard
            </p>
