...
<body>
        <nav id="navbar">
            ...
            <ul id="menu">
                ...
                <li class="li"><a href="adminlogin"><i class="fa fa-fw fa-user"></i><b> Admin</b></a></li>
                <li class="li"><a href="libSignInAndRegistration"><i class="fa fa-fw fa-user"></i><b> Librarian</b></a></li>
                <li class="li"><a href="userlogin"><i class="fa fa-fw fa-user"></i><b> User</b></a></li>
