    ...
    <section class="dashboard">
        ...
        <main class="table">
            <section class="table__header">
                <h1 style="text-decoration: none; color: #009688;">LIBRARIAN DATA </h1>
            ...
            <section class="table__body">
                <table>
                    ...
                    <tbody>
                         <c:forEach items="${libdata}"  var="lib"> 
            <tr> 
              <td><c:out value="${lib.id}" /></td> 
              <td><c:out value="${lib.name}" /></td> 
              <td><c:out value="${lib.email}" /></td> 
              <td><c:out value="${lib.contact}" /></td> 
                 <td>
              <a style="text-decoration: none; color: #009688;" href='<c:url value="viewlibadmin?id=${lib.id}"></c:url>'>View</a>
              </td>
                  <td>
              <a onclick="showPopup()" style="text-decoration: none; color: #009688;" href='<c:url value="deletelibadmin?id=${lib.id}"></c:url>'>Delete</a>
              </td>
            </tr> 
          </c:forEach> 
                    </tbody>
     ...
     <div>
        ...
        <a href="addLibrarianAdmin"><button type="button">ADD LIBRARIAN &#x27F6; </button></a>
        <div id="popupBox"></div>
    </div>
    </section>
